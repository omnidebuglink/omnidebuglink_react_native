// @omnidebuglink/react-native v0.1.2
"use strict";
...
__export(index_exports, {
  CLOSE_CODE_REPLACED: () => CLOSE_CODE,
  LIB_VERSION: () => LIB_VERSION,
  LinkConnection: () => LinkConnection,
  OmniDebugLink: () => OmniDebugLink,
  TaskRegistry: () => TaskRegistry,
  getNavigatorState: () => getNavigatorState,
  installErrorCapture: () => installErrorCapture,
  installLogCapture: () => installLogCapture,
  pushLog: () => pushLog,
  readLogs: () => readLogs,
  registerBuiltinTasks: () => registerBuiltinTasks,
